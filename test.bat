...
call sql2008r2\backup_sql_with_fulltime_folder.bat "MSSQLSERVER" "Test" "C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA" "D:\SQL_Server_2008_R2_Backup\"
REM "MSSQLSERVER"